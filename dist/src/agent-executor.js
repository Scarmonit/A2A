...
export class AgentExecutor {
    ...
    async executeCapability(agent, capability, input, context, toolsUsed, changes) {
    ...
    async executeTool(toolName, params, context, toolsUsed, changes) {
    ...
    async executeAdvancedTool(toolName, params, context, toolsUsed, changes) {
        toolsUsed.push(toolName);
        const startTime = Date.now();
    ...
    async simulateSecurityScan(input, context, toolsUsed, changes) {
    ...
    async simulateDeployment(input, context, toolsUsed, changes) {
    ...
    async executeGenericCapability(agent, capability, input, context, toolsUsed, changes) {
